...
const botname = process.env.BOTNAME || '𝐒𝐇𝐀𝐃𝐎𝐖-𝐗𝐌𝐃';
const antibot = process.env.ANTIBOT || 'FALSE';
const author = process.env.STICKER_AUTHOR ||'𝐗𝐌𝐃';
const packname = process.env.STICKER_PACKNAME || '𝐒𝐇𝐀𝐃𝐎𝐖';
const dev = process.env.DEV || '254759000340';
