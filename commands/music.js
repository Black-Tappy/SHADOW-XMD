...
cmd({
  ...
  reply("> ꜱʜᴀᴅᴏᴡ-xᴍᴅ🫅ɪs ғᴇᴛᴄʜɪɴɢ ᴀᴜᴅɪᴏ... 🎧");
  ...
  if (!spotifySent && !youtubeSent) {
    ...
    reply("ꜱʜᴀᴅᴏᴡ-xᴍᴅ🫅: sᴘᴏᴛɪғʏ ᴀᴜᴅɪᴏ sᴇɴᴛ sᴜᴄᴄᴇsғᴜʟʟʏ.");
  } else if (youtubeSent) {
    reply("ꜱʜᴀᴅᴏᴡ-xᴍᴅ: ʏᴏᴜᴛᴜʙᴇ ᴀᴜᴅɪᴏ sᴇɴᴛ sᴜᴄᴄᴇsғᴜʟʟʏ.");
  }
});
